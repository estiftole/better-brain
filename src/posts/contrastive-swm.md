...
For my evaluations, I compared the C-SWM to a version of the model that was trained on reconstruction loss, much like an autoencoder. Performance was compared on two Atari games. 

Results mimic that of the original paper, with the C-SWM model performing better than the autoencoder version.
